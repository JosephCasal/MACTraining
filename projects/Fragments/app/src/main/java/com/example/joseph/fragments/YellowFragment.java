    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btnSendData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //can also use the default created method call here
//                onButtonPressed("");


                //also can implement View.onclicklistener and have an onclick method in this class
                //and in there can have switch for view.getId() same as the main
    ...
    //to communicate from activity to the fragment
